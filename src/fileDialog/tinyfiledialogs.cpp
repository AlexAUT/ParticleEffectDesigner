...
static char* getPathWithoutFinalSlash(char* const aoDestination, /* make sure it is allocated, use _MAX_PATH */
...
static char* getLastName(char* const aoDestination, /* make sure it is allocated */
...
static void replaceSubStr(char const* const aSource, char const* const aOldSubStr, char const* const aNewSubStr,
...
static int replaceChr(char* const aString, char const aOldChr, char const aNewChr)
{
  char* p;
  int lRes = 0;
...
static wchar_t* getPathWithoutFinalSlashW(wchar_t* const aoDestination, /* make sure it is allocated, use _MAX_PATH */
...
static wchar_t* getLastNameW(wchar_t* const aoDestination, /* make sure it is allocated */
...
static void runSilentA(char const* const aString)
{
  ...
  if (!CreateProcessA(NULL, lArgs, NULL, NULL, FALSE, CREATE_NEW_CONSOLE, NULL, NULL, &StartupInfo, &ProcessInfo)) {
    free(lArgs);
    return; /* GetLastError(); */
  }
...
static void runSilentW(wchar_t const* const aString)
{
  ...
  if (!CreateProcessW(NULL, lArgs, NULL, NULL, FALSE, CREATE_NEW_CONSOLE, NULL, NULL, &StartupInfo, &ProcessInfo)) {
    free(lArgs);
    return; /* GetLastError(); */
  }
...
int tinyfd_messageBoxW(wchar_t const* const aTitle,      /* NULL or "" */
                       ...
                       int const aDefaultButton)         /* 0 for cancel/no , 1 for ok/yes , 2 for no in yesnocancel */
{
  ...
  if (((aDialogType && wcscmp(L"okcancel", aDialogType) && wcscmp(L"yesno", aDialogType))) ||
      (lBoxReturnValue == IDOK) || (lBoxReturnValue == IDYES)) {
    return 1;
  } else {
    return 0;
  }
...
static int messageBoxWinGui8(char const* const aTitle,      /* NULL or "" */
...
static char const* inputBoxWinGui(char* const aoBuff, char const* const aTitle, /* NULL or "" */
                                  ...
                                  char const* const aDefaultInput) /* "" , if NULL it's a passwordBox */
{
  ...
  if (aDefaultInput) {
    sprintf(lDialogString, "%s\\AppData\\Local\\Temp\\tinyfd.vbs", getenv("USERPROFILE"));
  } else {
    sprintf(lDialogString, "%s\\AppData\\Local\\Temp\\tinyfd.hta", getenv("USERPROFILE"));
  }
...
",
  ...
  if (aDefaultInput) {
    ...
    strcat(lDialogString, "mshta.exe %USERPROFILE%\\AppData\\Local\\Temp\\tinyfd.hta");
  }
  ...
  */
  ...
  if (aDefaultInput) {
    sprintf(lDialogString, "%s\\AppData\\Local\\Temp\\tinyfd.txt", getenv("USERPROFILE"));
...
wchar_t const* tinyfd_saveFileDialogW(wchar_t const* const aTitle,                   /* NULL or "" */
...
static char const* saveFileDialogWinGui8(char* const aoBuff, char const* const aTitle, /* NULL or "" */
                                         ...
                                         char const* const aSingleFilterDescription)   /* NULL or "image files" */
{
  ...
  lTmpWChar = tinyfd_saveFileDialogW(lTitle, lDefaultPathAndFile, aNumOfFilterPatterns,
...
wchar_t const* tinyfd_openFileDialogW(wchar_t const* const aTitle,                   /*  NULL or "" */
                                      wchar_t const* const aDefaultPathAndFile,      /*  NULL or "" */
                                      int const aNumOfFilterPatterns,                /* 0 */
                                      wchar_t const* const* const aFilterPatterns,   /* NULL or {"*.jpg","*.png"} */
                                      wchar_t const* const aSingleFilterDescription, /* NULL or "image files" */
...
static char const* openFileDialogWinGui8(char* const aoBuff, char const* const aTitle, /*  NULL or "" */
                                         char const* const aDefaultPathAndFile,        /*  NULL or "" */
                                         int const aNumOfFilterPatterns,               /* 0 */
                                         char const* const* const aFilterPatterns,     /* NULL or {"*.jpg","*.png"} */
                                         char const* const aSingleFilterDescription,   /* NULL or "image files" */
                                         int const aAllowMultipleSelects)              /* 0 or 1 */
{
  ...
  lTmpWChar = tinyfd_openFileDialogW(lTitle, lDefaultPathAndFile, aNumOfFilterPatterns,
                                     (wchar_t const**)/*stupid cast for gcc*/
                                     lFilterPatterns,
...
wchar_t const* tinyfd_selectFolderDialogW(wchar_t const* const aTitle,       /*  NULL or "" */
...
static char const* selectFolderDialogWinGui8(char* const aoBuff, char const* const aTitle, /*  NULL or "" */
...
wchar_t const* tinyfd_colorChooserW(wchar_t const* const aTitle,         /* NULL or "" */
...
static char const* colorChooserWinGui8(char const* const aTitle,           /* NULL or "" */
                                       ...
                                       unsigned char aoResultRGB[3])       /* { 0 , 0 , 0 } */
{
  ...
  lTmpWChar = tinyfd_colorChooserW(lTitle, lDefaultHexRGB, aDefaultRGB, aoResultRGB);
...
static int messageBoxWinGuiA(char const* const aTitle,      /* NULL or "" */
                             char const* const aMessage,    /* NULL or ""  may contain \n and \t */
                             char const* const aDialogType, /* "ok" "okcancel" "yesno" "yesnocancel" */
                             char const* const aIconType,   /* "info" "warning" "error" "question" */
                             int const aDefaultButton) /* 0 for cancel/no , 1 for ok/yes , 2 for no in yesnocancel */
{
  ...
  if (((aDialogType && !strcmp("yesnocancel", aDialogType)) && (lBoxReturnValue == IDNO))) {
    return 2;
  }

  if (((aDialogType && strcmp("yesnocancel", aDialogType) && strcmp("okcancel", aDialogType) &&
...
static char const* saveFileDialogWinGuiA(char* const aoBuff, char const* const aTitle, /* NULL or "" */
                                         char const* const aDefaultPathAndFile,        /* NULL or "" */
                                         int const aNumOfFilterPatterns,               /* 0 */
                                         char const* const* const aFilterPatterns,     /* NULL or {"*.jpg","*.png"} */
                                         char const* const aSingleFilterDescription)   /* NULL or "image files" */
...
static char const* openFileDialogWinGuiA(char* const aoBuff, char const* const aTitle, /*  NULL or "" */
                                         char const* const aDefaultPathAndFile,        /*  NULL or "" */
                                         int const aNumOfFilterPatterns,               /* 0 */
                                         char const* const* const aFilterPatterns,     /* NULL or {"*.jpg","*.png"} */
                                         char const* const aSingleFilterDescription,   /* NULL or "image files" */
...
#ifndef TINYFD_NOSELECTFOLDERWIN
static char const* selectFolderDialogWinGuiA(char* const aoBuff, char const* const aTitle, /*  NULL or "" */
                                             char const* const aDefaultPath)               /* NULL or "" */
{
  BROWSEINFOA bInfo;
  LPITEMIDLIST lpItem;
...
static char const* colorChooserWinGuiA(char const* const aTitle,           /* NULL or "" */
                                       char const* const aDefaultHexRGB,   /* NULL or "#FF0000"*/
                                       unsigned char const aDefaultRGB[3], /* { 0 , 255 , 255 } */
                                       unsigned char aoResultRGB[3])       /* { 0 , 0 , 0 } */
{
...
static int messageBoxWinConsole(char const* const aTitle,      /* NULL or "" */
                                char const* const aMessage,    /* NULL or ""  may contain \n and \t */
                                char const* const aDialogType, /* "ok" "okcancel" "yesno" "yesnocancel" */
                                char const* const aIconType,   /* "info" "warning" "error" "question" */
                                int const aDefaultButton) /* 0 for cancel/no , 1 for ok/yes , 2 for no in yesnocancel */
{
  ...
  if (aDialogType &&
      (!strcmp("okcancel", aDialogType) || !strcmp("yesno", aDialogType) || !strcmp("yesnocancel", aDialogType))) {
...
static char const* inputBoxWinConsole(char* const aoBuff, char const* const aTitle, /* NULL or "" */
                                      char const* const aMessage,      /* NULL or "" may NOT contain \n nor \t */
                                      char const* const aDefaultInput) /* "" , if NULL it's a passwordBox */
{
  char lDialogString[MAX_PATH_OR_CMD];
...
static char const* saveFileDialogWinConsole(char* const aoBuff, char const* const aTitle, /* NULL or "" */
                                            char const* const aDefaultPathAndFile)        /* NULL or "" */
{
  char lDialogString[MAX_PATH_OR_CMD];
...
static char const* openFileDialogWinConsole(char* const aoBuff, char const* const aTitle, /*  NULL or "" */
                                            char const* const aDefaultPathAndFile,        /*  NULL or "" */
                                            int const aAllowMultipleSelects)              /* 0 or 1 */
{
  char lFilterPatterns[MAX_PATH_OR_CMD] = "";
...
static char const* selectFolderDialogWinConsole(char* const aoBuff, char const* const aTitle, /*  NULL or "" */
                                                char const* const aDefaultPath)               /* NULL or "" */
{
  char lDialogString[MAX_PATH_OR_CMD];
...
int tinyfd_messageBox(char const* const aTitle,      /* NULL or "" */
                      char const* const aMessage,    /* NULL or ""  may contain \n and \t */
                      char const* const aDialogType, /* "ok" "okcancel" "yesno" "yesnocancel" */
                      char const* const aIconType,   /* "info" "warning" "error" "question" */
                      int const aDefaultButton)      /* 0 for cancel/no , 1 for ok/yes , 2 for no in yesnocancel */
{
  ...
  if ((!tinyfd_forceConsole || !(GetConsoleWindow() || dialogPresent())) &&
    ...
    if (tinyfd_winUtf8) {
      return messageBoxWinGui8(aTitle, aMessage, aDialogType, aIconType, aDefaultButton);
    } else {
      return messageBoxWinGuiA(aTitle, aMessage, aDialogType, aIconType, aDefaultButton);
    }
  } else
#endif /* TINYFD_NOLIB */
      if (dialogPresent()) {
    ...
    return messageBoxWinConsole(aTitle, aMessage, aDialogType, aIconType, aDefaultButton);
  } else {
    if (aTitle && !strcmp(aTitle, "tinyfd_query")) {
...
char const* tinyfd_inputBox(char const* const aTitle,        /* NULL or "" */
                            char const* const aMessage,      /* NULL or "" may NOT contain \n nor \t */
                            char const* const aDefaultInput) /* "" , if NULL it's a passwordBox */
{
...
char const* tinyfd_saveFileDialog(char const* const aTitle,                   /* NULL or "" */
                                  char const* const aDefaultPathAndFile,      /* NULL or "" */
                                  int const aNumOfFilterPatterns,             /* 0 */
                                  char const* const* const aFilterPatterns,   /* NULL or {"*.jpg","*.png"} */
                                  char const* const aSingleFilterDescription) /* NULL or "image files" */
{
  ...
  if ((!tinyfd_forceConsole || !(GetConsoleWindow() || dialogPresent())) &&
    ...
    if (tinyfd_winUtf8) {
      p = saveFileDialogWinGui8(lBuff, aTitle, aDefaultPathAndFile, aNumOfFilterPatterns, aFilterPatterns,
                                aSingleFilterDescription);
    } else {
      p = saveFileDialogWinGuiA(lBuff, aTitle, aDefaultPathAndFile, aNumOfFilterPatterns, aFilterPatterns,
                                aSingleFilterDescription);
    }
  } else
#endif /* TINYFD_NOLIB */
...
char const* tinyfd_openFileDialog(char const* const aTitle,                   /*  NULL or "" */
                                  char const* const aDefaultPathAndFile,      /*  NULL or "" */
                                  int const aNumOfFilterPatterns,             /* 0 */
                                  char const* const* const aFilterPatterns,   /* NULL or {"*.jpg","*.png"} */
                                  char const* const aSingleFilterDescription, /* NULL or "image files" */
                                  int const aAllowMultipleSelects)            /* 0 or 1 */
{
  ...
  if ((!tinyfd_forceConsole || !(GetConsoleWindow() || dialogPresent())) &&
    ...
    if (tinyfd_winUtf8) {
      p = openFileDialogWinGui8(lBuff, aTitle, aDefaultPathAndFile, aNumOfFilterPatterns, aFilterPatterns,
                                aSingleFilterDescription, aAllowMultipleSelects);
    } else {
      p = openFileDialogWinGuiA(lBuff, aTitle, aDefaultPathAndFile, aNumOfFilterPatterns, aFilterPatterns,
                                aSingleFilterDescription, aAllowMultipleSelects);
    }
  } else
#endif /* TINYFD_NOLIB */
    ...
    p = openFileDialogWinConsole(lBuff, aTitle, aDefaultPathAndFile, aAllowMultipleSelects);
  } else {
    if (aTitle && !strcmp(aTitle, "tinyfd_query")) {
      strcpy(tinyfd_response, "basicinput");
      return (char const*)0;
...
char const* tinyfd_colorChooser(char const* const aTitle,           /* NULL or "" */
                                char const* const aDefaultHexRGB,   /* NULL or "#FF0000"*/
                                unsigned char const aDefaultRGB[3], /* { 0 , 255 , 255 } */
                                unsigned char aoResultRGB[3])       /* { 0 , 0 , 0 } */
{
  ...
  if ((!tinyfd_forceConsole || !(GetConsoleWindow() || dialogPresent())) &&
    ...
    if (tinyfd_winUtf8) {
      return colorChooserWinGui8(aTitle, aDefaultHexRGB, aDefaultRGB, aoResultRGB);
    } else {
      return colorChooserWinGuiA(aTitle, aDefaultHexRGB, aDefaultRGB, aoResultRGB);
    }
  } else
#endif /* TINYFD_NOLIB */
      if (aDefaultHexRGB) {
  ...
  p = tinyfd_inputBox(aTitle, "Enter hex rgb color (i.e. #f5ca20)", lpDefaultHexRGB);
  if (aTitle && !strcmp(aTitle, "tinyfd_query"))
    return p;
...
int isDialogVersionBetter09b()
{
  ...
  if (!lDialogName || !(lVersion = (char*)getVersion(lDialogName)))
    return 0;
  /*lVersion = lTest ;*/
  /*printf("lVersion %s\n", lVersion);*/
...
static int graphicMode()
{
  return !(tinyfd_forceConsole && (isTerminalRunning() || terminalName())) &&
         (getenv("DISPLAY") || (isDarwin() && (!getenv("SSH_TTY") || getenv("DISPLAY"))));
}
...
static int tkinter2Present()
{
  ...
  if (lTkinter2Present < 0) {
    ...
    if (!detectPresence(gPython2Name) || !(lTkinter2Present = tryCommand(lPythonCommand))) {
                      ...
                      int const aDefaultButton)      /* 0 for cancel/no , 1 for ok/yes , 2 for no in yesnocancel */
{
  ...
  if (osascriptPresent()) {
    ...
    strcat(lDialogString, "-e 'if vButton is \"Yes\" then' -e 'return 1' -e 'else if vButton is \"No\" then' -e "
                          "'return 2' -e 'else' -e 'return 0' -e 'end if' ");
    ...
    if (zenity3Present() >= 3) {
      ...
      if (aIconType &&
          (!strcmp("question", aIconType) || !strcmp("error", aIconType) || !strcmp("warning", aIconType))) {
    ...
    if (aTitle && !strcmp(aTitle, "tinyfd_query")) {
      strcpy(tinyfd_response, "tkinter");
      return 1;
    }
    ...
    strcat(lDialogString, " -c \"import Tkinter,tkMessageBox;root=Tkinter.Tk();root.withdraw();");
                            ...
                            char const* const aDefaultInput) /* "" , if NULL it's a passwordBox */
{
  ...
  if (osascriptPresent()) {
    ...
    strcat(lDialogString, " -c \"import Tkinter,tkSimpleDialog;root=Tkinter.Tk();root.withdraw();");
                                  ...
                                  char const* const aSingleFilterDescription) /* NULL or "image files" */
{
  ...
  if (osascriptPresent()) {
    ...
    strcat(lDialogString, " -c \"import Tkinter,tkFileDialog;root=Tkinter.Tk();root.withdraw();");
...
to set mycolor to choose color default color {");
    ...
    if (zenity3Present()) {
      ...
      sprintf(lDialogString, "zenity --color-selection --show-palette --color=%s", lpDefaultHexRGB);
    } else if (matedialogPresent()) {
      if (aTitle && !strcmp(aTitle, "tinyfd_query")) {
        strcpy(tinyfd_response, "matedialog");
        return (char const*)1;
      }
      sprintf(lDialogString, "matedialog --color-selection --show-palette --color=%s", lpDefaultHexRGB);
    } else {
      if (aTitle && !strcmp(aTitle, "tinyfd_query")) {
        strcpy(tinyfd_response, "qarma");
        return (char const*)1;
      }
      sprintf(lDialogString, "qarma --color-selection --show-palette --color=%s", lpDefaultHexRGB);
    }
    ...
    strcat(lDialogString, " -c \"import Tkinter,tkColorChooser;root=Tkinter.Tk();root.withdraw();");
